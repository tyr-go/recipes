...
type Task struct {
	...
	Status    string     `json:"status" doc:"todo, doing or done."`
...
type CreateTaskReq struct {
	...
	Status    string     `json:"status,omitzero" validate:"omitempty,oneof=todo doing done" doc:"todo, doing or done: todo if not set."`
...
type ListTasksReq struct {
	ProjectID uuid.UUID `json:"project_id" path:"project_id" validate:"required" doc:"The id of the project."`
	Status    string    `json:"status,omitzero" query:"status" validate:"omitempty,oneof=todo doing done" doc:"Only the tasks of the status, if set: todo, doing or done."`
...
type UpdateTaskReq struct {
	...
	Status *string    `json:"status,omitzero" validate:"omitempty,oneof=todo doing done" doc:"todo, doing or done."`
	DueAt  *time.Time `json:"due_at,omitzero" doc:"When the task is due."`
}
